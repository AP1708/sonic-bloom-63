  ...
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "IMUSIC" },
      {
        ...
        content: "xypBFL5-XhGsKxe6fhfxPNfWGFNcRpAs_iRz7JPo9u8",
      },
    ],
    links: [
      {
      ...
      { rel: "shortcut icon", type: "image/png", href: "/favicon-32x32.png" },
...
function RootComponent() {
  ...
  // Offline-ready cache for app data (playlists, library, search metadata).
  useEffect(() => {
